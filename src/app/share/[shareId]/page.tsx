...
export default function SharePage({ params }: SharePageProps) {
  ...
  const conversation = useQuery(
    api.conversations.getByShareId,
    { 
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="text-center space-y-4">
            <p className="text-muted-foreground text-balance">
              This conversation link is invalid, has expired, or is no longer being shared.
            </p>
            <div className="space-y-2 text-muted-foreground">
              <p>Possible reasons</p>
              <ul className=" space-y-1">
                <li className="border rounded-md p-2">The link has expired</li>
                <li className="border rounded-md p-2">The conversation is no longer public</li>
                <li className="border rounded-md p-2">The conversation has been deleted</li>
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="text-center text-sm text-muted-foreground">
            ...
            <p className="mt-1">
              ...
              >
                {typeof window !== "undefined" ? window.location.host : "r3chat.com"}
              </Link>
            </p>
          </div>
        </div>

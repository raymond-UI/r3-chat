    ...
    <div className={cn("markdown-content max-w-full", className)}>
      <ReactMarkdown
        components={{
          ...
          h1({ children }) {
            return (
              <h1 className="text-lg font-semibold mb-3 text-foreground max-w-fit">
                {children}
              </h1>
            );
          },
          h2({ children }) {
            return (
              <h2 className="text-base font-medium mb-2 text-foreground max-w-fit">
                {children}
              </h2>
            );
          },
          h3({ children }) {
            return (
              <h3 className="text-base font-medium mb-2 text-foreground max-w-fit">
                {children}
              </h3>
            );
          },
          ...
          li({ children }) {
            return (
              <li className="leading-7 tracking-wide text-foreground text-base max-w-full">
                {children}
              </li>
            );
          },
